...
Public Class DataObat
    ...
    Private Sub AddParameters(str As String)
        ...
        If str = "Update" Or str = "Delete" And Not String.IsNullOrEmpty(Me.ID) Then
            Cmd.Parameters.AddWithValue("@id_obat", Me.ID)
        End If
    End Sub


    Private Sub loadData(Optional keyword As String = "")
        SQL = "SELECT * FROM tb_obat WHERE nama LIKE @keyword1 ORDER BY id_obat ASC "
    ...
    Private Sub btnTambah_Click(sender As Object, e As EventArgs) Handles btnTambah.Click
        If String.IsNullOrEmpty(tNama.Text.Trim()) Then
            MsgBox("Tolong isi dulu isianya", MsgBoxStyle.OkOnly Or MsgBoxStyle.Exclamation,
                   "Peringatan")
        Else
            SQL = "Insert into tb_obat(nama) VALUES(@nama)"
            Execute(SQL, "Insert")
    ...
    Private Sub btnPerbarui_Click(sender As Object, e As EventArgs) Handles btnPerbarui.Click
        ...
        If String.IsNullOrEmpty(tNama.Text.Trim()) Then
            MsgBox("Tolong isi dulu isianya", MsgBoxStyle.OkOnly Or MsgBoxStyle.Exclamation,
                   "PERINGATAN")
        Else
            SQL = "UPDATE tb_obat SET nama = @nama WHERE id_obat= @id_obat"
            Execute(SQL, "Update")
